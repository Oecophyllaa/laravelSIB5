    ...
    <div class="row">
      ...
      <div class="col-xl-4 col-lg-5">
        <div class="card shadow mb-4">
          ...
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Chart Data Gender Pelanggan</h6>
          </div>
          <!-- Card Body -->
          <div class="card-body">
            ...
            <hr>
            Berikut ini adalah perbandingan gender dari pelanggan dengan total <strong>{{ $pelanggan }}</strong>
...
@push('after-script')
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
      new Chart(document.querySelector('#chartGender'), {
        type: 'doughnut',
        data: {
          labels: label_data,
          datasets: [{
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
      new Chart(document.querySelector('#chartHarga'), {
        type: 'line',
        data: {
          labels: lbl,
          datasets: [{
